...
// ui - layout/구조
export { default as BottomSticky } from './ui/BottomSticky.vue';
export { default as Box } from './ui/Box.vue';
export { default as Container } from './ui/Container.vue';
...
// ui - 기타
export { default as Lottie } from './ui/Lottie.vue';
export { default as ResultView } from './ui/ResultView.vue';
