...
export { default as IArrowLeft } from '../assets/icons/arrow-left.svg';
export { default as IArrowRightS } from '../assets/icons/arrow-right-s.svg';
export { default as IArrowSelect } from '../assets/icons/arrow-select.svg';
